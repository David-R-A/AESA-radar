// aesa_radar_hps_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module aesa_radar_hps_mm_interconnect_1 (
	...
	wire  [153:0] address_span_extender_0_expanded_master_agent_cp_data;                                      // address_span_extender_0_expanded_master_agent:cp_data -> router:sink_data
	...
	wire          router_src_valid;                                                                           // router:src_valid -> address_span_extender_0_expanded_master_limiter:cmd_sink_valid
	wire  [153:0] router_src_data;                                                                            // router:src_data -> address_span_extender_0_expanded_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                           // address_span_extender_0_expanded_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                                         // router:src_channel -> address_span_extender_0_expanded_master_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                                                   // router:src_startofpacket -> address_span_extender_0_expanded_master_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                                                     // router:src_endofpacket -> address_span_extender_0_expanded_master_limiter:cmd_sink_endofpacket
	wire  [153:0] address_span_extender_0_expanded_master_limiter_cmd_src_data;                               // address_span_extender_0_expanded_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          address_span_extender_0_expanded_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> address_span_extender_0_expanded_master_limiter:cmd_src_ready
	wire    [1:0] address_span_extender_0_expanded_master_limiter_cmd_src_channel;                            // address_span_extender_0_expanded_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          address_span_extender_0_expanded_master_limiter_cmd_src_startofpacket;                      // address_span_extender_0_expanded_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire          address_span_extender_0_expanded_master_limiter_cmd_src_endofpacket;                        // address_span_extender_0_expanded_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                                                          // rsp_mux:src_valid -> address_span_extender_0_expanded_master_limiter:rsp_sink_valid
	wire  [153:0] rsp_mux_src_data;                                                                           // rsp_mux:src_data -> address_span_extender_0_expanded_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                          // address_span_extender_0_expanded_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                        // rsp_mux:src_channel -> address_span_extender_0_expanded_master_limiter:rsp_sink_channel
	wire          rsp_mux_src_startofpacket;                                                                  // rsp_mux:src_startofpacket -> address_span_extender_0_expanded_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                    // rsp_mux:src_endofpacket -> address_span_extender_0_expanded_master_limiter:rsp_sink_endofpacket
	wire          address_span_extender_0_expanded_master_limiter_rsp_src_valid;                              // address_span_extender_0_expanded_master_limiter:rsp_src_valid -> address_span_extender_0_expanded_master_agent:rp_valid
	wire  [153:0] address_span_extender_0_expanded_master_limiter_rsp_src_data;                               // address_span_extender_0_expanded_master_limiter:rsp_src_data -> address_span_extender_0_expanded_master_agent:rp_data
	wire          address_span_extender_0_expanded_master_limiter_rsp_src_ready;                              // address_span_extender_0_expanded_master_agent:rp_ready -> address_span_extender_0_expanded_master_limiter:rsp_src_ready
	wire    [1:0] address_span_extender_0_expanded_master_limiter_rsp_src_channel;                            // address_span_extender_0_expanded_master_limiter:rsp_src_channel -> address_span_extender_0_expanded_master_agent:rp_channel
	wire          address_span_extender_0_expanded_master_limiter_rsp_src_startofpacket;                      // address_span_extender_0_expanded_master_limiter:rsp_src_startofpacket -> address_span_extender_0_expanded_master_agent:rp_startofpacket
	wire          address_span_extender_0_expanded_master_limiter_rsp_src_endofpacket;                        // address_span_extender_0_expanded_master_limiter:rsp_src_endofpacket -> address_span_extender_0_expanded_master_agent:rp_endofpacket
	...
	wire    [1:0] address_span_extender_0_expanded_master_limiter_cmd_valid_data;                             // address_span_extender_0_expanded_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (address_span_extender_0_expanded_master_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (address_span_extender_0_expanded_master_limiter_rsp_src_data),                               //          .data
		.rp_channel            (address_span_extender_0_expanded_master_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (address_span_extender_0_expanded_master_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (address_span_extender_0_expanded_master_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (address_span_extender_0_expanded_master_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                                           // (terminated)
		.av_writeresponsevalid ()                                                                                            // (terminated)
	);
	...
	altera_merlin_axi_slave_ni #(
		...
		.aresetn                (~address_span_extender_0_reset_reset_bridge_in_reset_reset), //        reset_sink.reset_n
	...
	aesa_radar_hps_mm_interconnect_1_router router (
	...
	aesa_radar_hps_mm_interconnect_1_router_001 router_001 (
	...
	aesa_radar_hps_mm_interconnect_1_router_001 router_002 (
	...
	altera_merlin_traffic_limiter #(
		...
		.REORDER                   (0)
	) address_span_extender_0_expanded_master_limiter (
		.clk                    (clk_0_clk_clk),                                                         //       clk.clk
		.reset                  (address_span_extender_0_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		...
		.cmd_src_ready          (address_span_extender_0_expanded_master_limiter_cmd_src_ready),         //   cmd_src.ready
		.cmd_src_data           (address_span_extender_0_expanded_master_limiter_cmd_src_data),          //          .data
		.cmd_src_channel        (address_span_extender_0_expanded_master_limiter_cmd_src_channel),       //          .channel
		.cmd_src_startofpacket  (address_span_extender_0_expanded_master_limiter_cmd_src_startofpacket), //          .startofpacket
		.cmd_src_endofpacket    (address_span_extender_0_expanded_master_limiter_cmd_src_endofpacket),   //          .endofpacket
		...
		.rsp_src_ready          (address_span_extender_0_expanded_master_limiter_rsp_src_ready),         //   rsp_src.ready
		.rsp_src_valid          (address_span_extender_0_expanded_master_limiter_rsp_src_valid),         //          .valid
		.rsp_src_data           (address_span_extender_0_expanded_master_limiter_rsp_src_data),          //          .data
		.rsp_src_channel        (address_span_extender_0_expanded_master_limiter_rsp_src_channel),       //          .channel
		.rsp_src_startofpacket  (address_span_extender_0_expanded_master_limiter_rsp_src_startofpacket), //          .startofpacket
		.rsp_src_endofpacket    (address_span_extender_0_expanded_master_limiter_rsp_src_endofpacket),   //          .endofpacket
		.cmd_src_valid          (address_span_extender_0_expanded_master_limiter_cmd_valid_data)         // cmd_valid.data
	);

	aesa_radar_hps_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                         //        clk.clk
		.reset              (address_span_extender_0_reset_reset_bridge_in_reset_reset),             //  clk_reset.reset
		.sink_ready         (address_span_extender_0_expanded_master_limiter_cmd_src_ready),         //       sink.ready
		.sink_channel       (address_span_extender_0_expanded_master_limiter_cmd_src_channel),       //           .channel
		.sink_data          (address_span_extender_0_expanded_master_limiter_cmd_src_data),          //           .data
		.sink_startofpacket (address_span_extender_0_expanded_master_limiter_cmd_src_startofpacket), //           .startofpacket
		.sink_endofpacket   (address_span_extender_0_expanded_master_limiter_cmd_src_endofpacket),   //           .endofpacket
		.sink_valid         (address_span_extender_0_expanded_master_limiter_cmd_valid_data),        // sink_valid.data
	...
	aesa_radar_hps_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	aesa_radar_hps_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	aesa_radar_hps_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	aesa_radar_hps_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	aesa_radar_hps_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (address_span_extender_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
