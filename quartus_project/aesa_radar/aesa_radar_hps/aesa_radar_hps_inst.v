	aesa_radar_hps u0 (
		...
		.fpga_state_reg_export               (<connected-to-fpga_state_reg_export>),               //          fpga_state_reg.export
		...
		.hps_state_reg_export                (<connected-to-hps_state_reg_export>),                //           hps_state_reg.export
		...
		.system_input_bridge_ei_acknowledge  (<connected-to-system_input_bridge_ei_acknowledge>),  //  system_input_bridge_ei.acknowledge
		.system_input_bridge_ei_irq          (<connected-to-system_input_bridge_ei_irq>),          //                        .irq
		.system_input_bridge_ei_address      (<connected-to-system_input_bridge_ei_address>),      //                        .address
		.system_input_bridge_ei_bus_enable   (<connected-to-system_input_bridge_ei_bus_enable>),   //                        .bus_enable
		.system_input_bridge_ei_byte_enable  (<connected-to-system_input_bridge_ei_byte_enable>),  //                        .byte_enable
		.system_input_bridge_ei_rw           (<connected-to-system_input_bridge_ei_rw>),           //                        .rw
		.system_input_bridge_ei_write_data   (<connected-to-system_input_bridge_ei_write_data>),   //                        .write_data
		.system_input_bridge_ei_read_data    (<connected-to-system_input_bridge_ei_read_data>),    //                        .read_data
		.system_output_bridge_ei_address     (<connected-to-system_output_bridge_ei_address>),     // system_output_bridge_ei.address
		.system_output_bridge_ei_byte_enable (<connected-to-system_output_bridge_ei_byte_enable>), //                        .byte_enable
		.system_output_bridge_ei_read        (<connected-to-system_output_bridge_ei_read>),        //                        .read
		.system_output_bridge_ei_write       (<connected-to-system_output_bridge_ei_write>),       //                        .write
		.system_output_bridge_ei_write_data  (<connected-to-system_output_bridge_ei_write_data>),  //                        .write_data
		.system_output_bridge_ei_acknowledge (<connected-to-system_output_bridge_ei_acknowledge>), //                        .acknowledge
		.system_output_bridge_ei_read_data   (<connected-to-system_output_bridge_ei_read_data>),   //                        .read_data
